...
foreach ($questions as $question) {
    ...
    // Encontrar cuál letra corresponde a la respuesta correcta
    $correctLetter = '';
    foreach ($options as $letter => $text) {
        if (strtolower(trim($text)) === strtolower(trim($question['correct_answer']))) {
            $correctLetter = $letter;
            break;
        }
    }
    
    // Si no encontramos la respuesta correcta por texto, asumimos que correct_answer es la letra
